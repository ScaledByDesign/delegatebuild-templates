...
// OmniCart Express Checkout — route map mirrors the upw-sendpaylinks headless
// checkout exactly. (OmniCart is the whitelabel brand; powered internally by
// the Medusa framework.) There is NO homepage / storefront / cart-summary
// landing:
