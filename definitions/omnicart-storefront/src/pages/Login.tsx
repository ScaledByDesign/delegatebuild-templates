...
import { Shield, Users, Award, Mail, Lock, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
        ...
        <div className="hidden lg:flex bg-vnsh-dark text-white p-12 flex-col justify-center">
          <div className="max-w-md">
            <h1 className="text-4xl font-bold mb-6">Welcome Back to VNSH</h1>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Trusted by Professionals</h3>
                  <p className="text-gray-300 text-sm">
                    Used by law enforcement, military, and civilian professionals worldwide.
                  </p>
                </div>
              </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-vnsh-dark mb-2">Welcome Back</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-sm text-vnsh-red hover:text-red-700">
                    Forgot password?
                  </Link>
                </div>
